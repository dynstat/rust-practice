...
pub fn test_types_match_typeid(value: &dyn Any) {
    match value.type_id() {
        id if id == TypeId::of::<i32>() => println!("hehe i32: {}", value.downcast_ref::<i32>().unwrap()),
        id if id == TypeId::of::<f64>() => println!("hehe f64: {}", value.downcast_ref::<f64>().unwrap()),
        id if id == TypeId::of::<String>() => println!("hehe String: {}", value.downcast_ref::<String>().unwrap()),
        id if id == TypeId::of::<&str>() => println!("hehe &str: {}", value.downcast_ref::<&str>().unwrap()),
